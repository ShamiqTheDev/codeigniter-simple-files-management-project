...
*/
	...
	*/ 
	...
	$config['database']['user_acc']['columns']['section'] = 'uacc_section_fk';
	$config['database']['user_acc']['columns']['designation'] = 'uacc_designation_fk';
	$config['database']['user_acc']['columns']['user_job_group'] = 'uacc_user_job_group_fk';
	 ...
	 * Pass History
	*/ 
	$config['database']['pass_history']['table'] = 'user_pass_history';
	$config['database']['pass_history']['join'] = 'user_pass_history.passHistoryId';
	$config['database']['pass_history']['columns']['id'] = 'passHistoryId';
	$config['database']['pass_history']['columns']['account_id'] = 'userAccountId';
	$config['database']['pass_history']['columns']['password'] = 'passHistoryPassword';
	$config['database']['pass_history']['columns']['date'] = 'passHistoryDate';
	 ...
	 * Terminal History
	*/ 
	$config['database']['terminal_history']['table'] = 'user_terminal_history';
	$config['database']['terminal_history']['join'] = 'user_terminal_history.terminalHistoryId';
	$config['database']['terminal_history']['columns']['id'] = 'terminalHistoryId';
	$config['database']['terminal_history']['columns']['account_id'] = 'userAccountId';
	$config['database']['terminal_history']['columns']['terminal_ip'] = 'terminalHistoryIP';
	$config['database']['terminal_history']['columns']['date'] = 'terminalHistoryDate';
	...
	*/ 
	...
	$config['database']['custom_join']['designation']['table'] = 'designation';
	$config['database']['custom_join']['designation']['primary_key'] = 'designationId';
	$config['database']['custom_join']['designation']['foreign_key'] = 'uacc_designation_fk';
	//$config['database']['custom_join']['designation']['join'] = "FIND_IN_SET(designation.designationId,user_accounts.`uacc_designation_fk`) > '0' ";
	//$config['database']['custom_join']['designation']['join'] = "designation.designationId";
	$config['database']['custom_join']['designation']['join_table'] = 'user_accounts';
	$config['database']['custom_join']['designation']['custom_columns'] = array(
		'designationName'
	);
	...
	*/ 
	...
	$config['security']['valid_password_special_chars'] = "/[\'^£$%&*()}{@#~?><>,|=_+!-]/";
	...
	*/
	...
	$config['security']['password_expire_days'] = 555555;
	$config['security']['admin_group_id'] = array('1');
	...
	*/
	 ...
	 * @param: int
	*/
	$config['settings']['default_group_id'] = 5;
	
	/**
	 * Set the id of the Master admin group 
	 * @param: int
	*/
	$config['settings']['master_admin_group_id'] = 1;
	...
	*/
	...
	$config['messages']['target_user']['account_pass_privous'] = 'public';
	...
	$config['messages']['target_user']['account_pass_expire'] = 'public';
	$config['messages']['target_user']['account_terminal_ip'] = 'public';
