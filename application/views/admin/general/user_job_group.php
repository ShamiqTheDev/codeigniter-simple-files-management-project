                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							<div class="form-group">
								<label class="col-sm-3 control-label" for="user_job_group_name">
									User Job Group Name <span style="color:red;">*</span>
								</label>
								<div class="col-sm-8">
									<input type="text" name="user_job_group_name" id="user_job_group_name" value="<?php echo isset($user_job_group['userJobGroupName']) ? $user_job_group['userJobGroupName'] : '' ?>" class="form-control">
								</div>
							</div>
						</div>
                        <div class="panel-body">
                            <div class="col-md-2 pull-right">
                                <button id="submit_btn" class="btn btn-yellow btn-block" type="submit">
                                    <?php echo isset($user_job_group) ? 'Update' : 'Submit'; ?> <i class="fa fa-arrow-circle-right"></i>
								</button>
							</div>
						</div>
                        <?php echo form_close(); ?>
	...
	var FormValidator = function () {
		...
		var custom_field_form = function () {
			...
			$('#custom_field_form').validate({
				...
				messages: {
					user_job_group_name: "Please enter user job group name",
