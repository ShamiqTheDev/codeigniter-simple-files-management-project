				...
				<div class="col-sm-12"> 
					...
					<div class="page-header row">
						...
						<div class="col-md-2 pull-right">
                            <a class="btn btn-teal btn-block" href="<?php echo $base_url; ?>admin/general/state">
								Add 						
							</a>
						</div>
					</div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                <thead>
                                    <tr>
                                        <th class="hidden-xs" width="65%">State Name</th>
                                        <th class="hidden-xs" width="65%">Country Name</th>
                                ...
                                <tbody>
									<?php
										if($state)
										{
											foreach($state as $key => $get_state)
											{l
											?>
											<tr>
												
												<td><?php echo $get_state['stateName']?></td>
												<td><?php echo $get_state['countryName']?></td>
												<td nowrap class="center">
													<div class="visible-md visible-lg hidden-sm hidden-xs">
														<a href="<?php echo $base_url; ?>admin/general/state/<?php echo $get_state['stateId']?>" class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit"><i class="fa fa-edit"></i></a>
													</div>
												</td>
											</tr>
											<?php }
