				...
				<div class="row">
					<div class="col-sm-12"> 
						...
						<div class="col-md-2 pull-right">
                            <a class="btn btn-teal btn-block" href="<?php echo $base_url; ?>admin/general/locations">
								Add 						
							</a>
						</div>
					</div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                <thead>
                                    <tr>
                                        <th class="hidden-xs" width="33%">Location Name</th>
                                        <th class="hidden-xs" width="32%">City Name</th>
								...
								<?php
									if($manage_locations)
									{
										foreach($manage_locations as $key => $get_location_name)
										{
									?>
									<tr>
										<td><?php echo $get_location_name['locationName']?></td>
										<td><?php echo $get_location_name['cityName']?></td>
										<td nowrap class="center">
											<div class="visible-md visible-lg hidden-sm hidden-xs">
												<a href="<?php echo $base_url; ?>admin/general/locations/<?php echo $get_location_name['locationId']?>" class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit"><i class="fa fa-edit"></i></a>
