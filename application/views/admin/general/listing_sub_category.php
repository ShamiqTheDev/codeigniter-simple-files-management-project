				...
				<div class="col-sm-12"> 
					...
					<div class="page-header row">
						...
						<div class="col-md-2 pull-right">
                            <a class="btn btn-teal btn-block" href="<?php echo $base_url; ?>admin/general/sub_category">
								Add 						
							</a>
						</div>
					</div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                <thead>
                                    <tr>
                                        <th class="hidden-xs" width="65%">Sub Category Name</th>
                                        <th class="hidden-xs" width="65%">Category Name</th>
                                ...
                                <tbody>
									<?php
										if($sub_category)
										{
											foreach($sub_category as $key => $get_sub_category)
											{l
											?>
											<tr>
												
												<td><?php echo $get_sub_category['subCategoryName']?></td>
												<td><?php echo $get_sub_category['categoryName']?></td>
												<td nowrap class="center">
													<div class="visible-md visible-lg hidden-sm hidden-xs">
														<a href="<?php echo $base_url; ?>admin/general/sub_category/<?php echo $get_sub_category['subCategoryId']?>" class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit"><i class="fa fa-edit"></i></a>
													</div>
												</td>
											</tr>
											<?php }
