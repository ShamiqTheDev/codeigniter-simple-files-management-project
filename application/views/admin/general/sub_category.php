                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
										...
										<?php
											if($category) {
												foreach($category as $get_category) {
													$selected = ($sub_category && $sub_category['categoryId'] == $get_category['categoryId']) ? 'selected="selected"' : '';
													
													echo '<option '.$selected.' value="'.$get_category['categoryId'].'">'.$get_category['categoryName'].'</option>';
												}
											}
										?>
									</select>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-8">
									<input type="text" name="sub_category_name" id="sub_category_name" value="<?php echo isset($sub_category['subCategoryName']) ? $sub_category['subCategoryName'] : '' ?>" class="form-control">
								</div>
							</div>
                        ...
                        <div class="panel-body">
                            <div class="col-md-2 pull-right">
                                <button id="submit_btn" class="btn btn-yellow btn-block" type="submit">
                                    <?php echo isset($sub_category) ? 'Update' : 'Submit'; ?> <i class="fa fa-arrow-circle-right"></i>
								</button>
							</div>
						</div>
                        <?php echo form_close(); ?>
