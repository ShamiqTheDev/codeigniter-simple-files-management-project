				...
				<div class="col-sm-12"> 
					...
					<div class="page-header row">
						...
						<div class="col-md-2 pull-right">
                            <a class="btn btn-teal btn-block" href="<?php echo $base_url; ?>admin/general/delivery_mode">
								Add 						
							</a>
						</div>
					</div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                <thead>
                                    <tr>
                                        <th class="hidden-xs" width="65%">Delivery Mode</th>
                                ...
                                <tbody>
									<?php
										if($delivery_mode)
										{
											foreach($delivery_mode as $key => $get_delivery_mode)
											{l
											?>
											<tr>
												
												<td><?php echo $get_delivery_mode['deliveryMode']?></td>
												<td nowrap class="center">
													<div class="visible-md visible-lg hidden-sm hidden-xs">
														<a href="<?php echo $base_url; ?>admin/general/delivery_mode/<?php echo $get_delivery_mode['deliveryModeId']?>" class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit"><i class="fa fa-edit"></i></a>
													</div>
												</td>
											</tr>
											<?php }
