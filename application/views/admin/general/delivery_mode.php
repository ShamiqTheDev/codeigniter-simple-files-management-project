					...
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="text" name="delivery_mode" id="delivery_mode" value="<?php echo isset($delivery_mode['deliveryMode']) ? $delivery_mode['deliveryMode'] : '' ?>" class="form-control">
								</div>
							</div>
						...
						<div class="panel-body">
							<div class="col-md-2 pull-right">
								<button id="submit_btn" class="btn btn-yellow btn-block" type="submit">
									<?php echo isset($delivery_mode) ? 'Update' : 'Submit'; ?> <i class="fa fa-arrow-circle-right"></i>
								</button>
							</div>
						</div>
						<?php echo form_close(); ?>
