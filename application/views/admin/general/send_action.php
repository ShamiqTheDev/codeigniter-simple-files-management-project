                        ...
                        <div class="panel-body">
							<div class="form-group">
                                <label class="col-sm-3 control-label" for="project_name">
                                    Send Action <span style="color:red;">*</span>
								</label>
                                <div class="col-sm-8">
									<input type="text" name="send_action" id="send_action" value="<?php echo isset($send_action['sendAction']) ? $send_action['sendAction'] : '' ?>" class="form-control">
								</div>
							</div>
                        ...
                        <div class="panel-body">
                            <div class="col-md-2 pull-right">
                                <button id="submit_btn" class="btn btn-yellow btn-block" type="submit">
                                    <?php echo isset($send_action) ? 'Update' : 'Submit'; ?> <i class="fa fa-arrow-circle-right"></i>
								</button>
							</div>
						</div>
                        <?php echo form_close(); ?>
	...
	var FormValidator = function () {
		...
		var custom_field_form = function () {
			...
			$('#custom_field_form').validate({
				...
				messages: {
					send_action: "Please enter send action",
