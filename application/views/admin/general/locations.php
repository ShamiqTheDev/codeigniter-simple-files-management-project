                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							<div class="form-group">
                                ...
                                <div class="col-sm-8">
									<input type="text" name="location_name" id="location_name" value="<?php echo isset($locations['locationName']) ? $locations['locationName'] : '' ?>" class="form-control">
								</div>
							</div>
							<div class="form-group">
                                <label class="col-sm-3 control-label" for="project_name">
											...
											<?php
												if($cities) {
													foreach($cities as $get_city) {
														$select = ($get_city['cityId'] == $locations['cityId']) ? 'selected="selected"' : set_select('city_id', $get_city['cityId']);
														echo '<option '.$select.' value="'.$get_city['cityId'].'">'.$get_city['cityName'].'</option>';
													}
												}
											?>
									</select>
                        ...
                        <div class="panel-body">
                            <div class="col-md-2 pull-right">
                                <button id="submit_btn" class="btn btn-yellow btn-block" type="submit">
                                    <?php echo isset($locations) ? 'Update' : 'Submit'; ?> <i class="fa fa-arrow-circle-right"></i>
								</button>
							</div>
						</div>
                        <?php echo form_close(); ?>
