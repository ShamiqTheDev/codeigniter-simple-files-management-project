                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							<div class="form-group">
                                ...
                                <div class="col-sm-8">
									<input type="text" name="file_type_name" id="file_type_name" value="<?php echo isset($file_type['fileType']) ? $file_type['fileType'] : '' ?>" class="form-control">
								</div>
						</div>
                        ...
                        <div class="panel-body">
                            <div class="col-md-2 pull-right">
                                <button id="submit_btn" class="btn btn-yellow btn-block" type="submit">
                                    <?php echo isset($file_type) ? 'Update' : 'Submit'; ?> <i class="fa fa-arrow-circle-right"></i>
								</button>
							</div>
						</div>
                        <?php echo form_close(); ?>
	...
	<script>
	   ...
	   var FormValidator = function () {
        ...
        $('#custom_field_form').validate({
            ...
            messages: {
				file_type_name: "Please Enter File Type",
