                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							<div class="form-group">
                                ...
                                <div class="col-sm-8">
									<input type="text" name="city_name" id="city_name" value="<?php echo isset($cities['cityName']) ? $cities['cityName'] : '' ?>" class="form-control">
								</div>
							</div>
							<div class="form-group">
                                <label class="col-sm-3 control-label" for="project_name">
                                ...
                                <div class="col-sm-8">
									<input type="text" name="city_code" id="city_code" value="<?php echo isset($cities['cityCode']) ? $cities['cityCode'] : '' ?>" class="form-control">
								</div>
							</div>
                        ...
                        <div class="panel-body">
                            <div class="col-md-2 pull-right">
                                <button id="submit_btn" class="btn btn-yellow btn-block" type="submit">
                                    <?php echo isset($cities) ? 'Update' : 'Submit'; ?> <i class="fa fa-arrow-circle-right"></i>
								</button>
							</div>
						</div>
                        <?php echo form_close(); ?>
