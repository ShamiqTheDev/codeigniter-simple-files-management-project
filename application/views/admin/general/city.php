                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
										...
										<?php
											if($state) {
												foreach($state as $get_state) {
													$selected = ($city && $city['stateId'] == $get_state['stateId']) ? 'selected="selected"' : '';
													
													echo '<option '.$selected.' value="'.$get_state['stateId'].'">'.$get_state['stateName'].'</option>';
												}
											}
										?>
									</select>
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-8">
									<input type="text" name="city_name" id="city_name" value="<?php echo isset($city['cityName']) ? $city['cityName'] : '' ?>" class="form-control">
								</div>
							</div>
                        ...
                        <div class="panel-body">
                            <div class="col-md-2 pull-right">
                                <button id="submit_btn" class="btn btn-yellow btn-block" type="submit">
                                    <?php echo isset($city) ? 'Update' : 'Submit'; ?> <i class="fa fa-arrow-circle-right"></i>
								</button>
							</div>
						</div>
                        <?php echo form_close(); ?>
