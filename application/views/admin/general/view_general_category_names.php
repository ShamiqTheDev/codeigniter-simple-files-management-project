				...
				<div class="row">
					<div class="col-sm-12"> 
						...
						<div class="col-md-2 pull-right">
                            <a class="btn btn-teal btn-block" href="<?php echo $base_url; ?>admin/general/add_general_file_category">
								Add 						
							</a>
						</div>
					</div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            ...
                            Manage General Category
						</div>
                        <div class="panel-body">
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                <thead>
                                    <tr>
                                        <th class="hidden-xs" width="40%">General Category Name</th>
                                        <th class="hidden-xs" width="30%">File Type</th>
										<th class="hidden-xs center">Action</th>
									</tr>
								</thead>
                                <tbody>
								<?php
									if($general_category_names)
									{
										foreach($general_category_names as $key => $get_general_category_name)
										{
									?>
									<tr>
										<td><?php echo $get_general_category_name['generalCategoryName']?></td>
										<td><?php echo $get_general_category_name['fileType']?></td>
										<td nowrap class="center">
											<div class="visible-md visible-lg hidden-sm hidden-xs">
												<a href="<?php echo $base_url; ?>admin/general/edit_general_file_category/<?php echo $get_general_category_name['generalCategoryId']?>" class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit"><i class="fa fa-edit"></i></a>
												<?php /*<a href="<?php echo $base_url; ?>admin/general/delete_general_file_category/<?php echo $get_general_category_name['generalCategoryId']?>" links="" class="btn btn-xs btn-bricky tooltips delete" data-placement="top" data-original-title="Remove"><i class="fa fa-times fa fa-white"></i></a> */?>
