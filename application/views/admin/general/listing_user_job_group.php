				...
				<div class="col-sm-12"> 
					...
					<div class="page-header row">
						...
						<div class="col-md-2 pull-right">
                            <a class="btn btn-teal btn-block" href="<?php echo $base_url; ?>admin/general/user_job_group">
								Add 						
							</a>
						</div>
					</div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                <thead>
                                    <tr>
                                        <th class="hidden-xs" width="40%">User Job Group Name</th>
                                ...
                                <tbody>
									<?php
										if($user_job_groups)
										{
											foreach($user_job_groups as $key => $get_user_job_group)
											{l
											?>
											<tr>
												
												<td><?php echo $get_user_job_group['userJobGroupName']?></td>
												<td nowrap class="center" style="width: 10%">
													<div class="visible-md visible-lg hidden-sm hidden-xs">
														<a href="<?php echo $base_url; ?>admin/general/user_job_group/<?php echo $get_user_job_group['userJobGroupId']?>" class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit"><i class="fa fa-edit"></i></a>
													</div>
												</td>
											</tr>
											<?php }
