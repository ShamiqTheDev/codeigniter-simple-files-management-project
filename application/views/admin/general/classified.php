						...
						<div class="panel-body">
							<div class="form-group">
								<label class="col-sm-3 control-label" for="project_name">
									Classified Name <span style="color:red;">*</span>
								</label>
								<div class="col-sm-8">
									<input type="text" name="classified_name" id="classified_name" value="<?php echo isset($classified['classifiedName']) ? $classified['classifiedName'] : '' ?>" class="form-control">
								</div>
							</div>
						...
						<div class="panel-body">
							<div class="col-md-2 pull-right">
								<button id="submit_btn" class="btn btn-yellow btn-block" type="submit">
									<?php echo isset($classified) ? 'Update' : 'Submit'; ?> <i class="fa fa-arrow-circle-right"></i>
								</button>
							</div>
						</div>
						<?php echo form_close(); ?>
	...
	var FormValidator = function () {
		...
		var custom_field_form = function () {
			...
			$('#custom_field_form').validate({
				...
				messages: {
					classified_name: "Please enter classified name",
