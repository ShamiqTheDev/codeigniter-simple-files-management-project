				...
				<div class="row">
					<div class="col-sm-12"> 
						...
						<div class="col-md-2 pull-right">
                            <a class="btn btn-teal btn-block" href="<?php echo $base_url; ?>admin/general/section">
								Add 						
							</a>
						</div>
					</div>
                            ...
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="hidden-xs" width="65%">Section Name</th>
								...
								<?php
									if($section)
									{
										foreach($section as $key => $get_section)
										{l
									?>
									<tr>
										
										<td><?php echo $get_section['sectionName']?></td>
										<td nowrap class="center">
											<div class="visible-md visible-lg hidden-sm hidden-xs">
												<a href="<?php echo $base_url; ?>admin/general/section/<?php echo $get_section['sectionId']?>" class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit"><i class="fa fa-edit"></i></a>
											</div>
										</td>
									</tr>
									<?php }
