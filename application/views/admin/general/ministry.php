                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							<div class="form-group">
                                ...
                                <div class="col-sm-8">
									<input type="text" name="ministry_name" id="ministry_name" value="<?php echo isset($ministry['ministryName']) ? $ministry['ministryName'] : '' ?>" class="form-control">
								</div>
							</div>
                        ...
                        <div class="panel-body">
                            <div class="col-md-2 pull-right">
                                <button id="submit_btn" class="btn btn-yellow btn-block" type="submit">
                                    <?php echo isset($ministry) ? 'Update' : 'Submit'; ?> <i class="fa fa-arrow-circle-right"></i>
								</button>
							</div>
						</div>
                        <?php echo form_close(); ?>
	...
	var FormValidator = function () {
		...
		var custom_field_form = function () {
			...
			$('#custom_field_form').validate({
				...
				messages: {
					ministry_name: "Please enter ministry name",
