				...
				<div class="row">
					<div class="col-sm-12"> 
						...
						<div class="col-md-2 pull-right">
                            <a class="btn btn-teal btn-block" href="<?php echo $base_url; ?>admin/general/cities">
								Add 						
							</a>
						</div>
					</div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                <thead>
                                    <tr>
                                        <th class="hidden-xs" width="33%">City Name</th>
                                        <th class="hidden-xs" width="32%">City Code</th>
								...
								<?php
									if($manage_cities)
									{
										foreach($manage_cities as $key => $get_city_name)
										{
									?>
									<tr>
										<td><?php echo $get_city_name['cityName']?></td>
										<td><?php echo $get_city_name['cityCode']?></td>
										<td nowrap class="center">
											<div class="visible-md visible-lg hidden-sm hidden-xs">
												<a href="<?php echo $base_url; ?>admin/general/cities/<?php echo $get_city_name['cityId']?>" class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit"><i class="fa fa-edit"></i></a>
