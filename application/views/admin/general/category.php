                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							<div class="form-group">
                                ...
                                <div class="col-sm-8">
									<input type="text" name="category_name" id="category_name" value="<?php echo isset($category['categoryName']) ? $category['categoryName'] : '' ?>" class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8 input-group colorpicker-component" id="color_picker" data-color="<?php echo isset($category['categoryColor']) ? $category['categoryColor'] : 'rgb(81, 145, 185)' ?>" style="padding-right: 15px; padding-left: 15px;">
									<input type="text" name="category_color" id="category_color" value="<?php echo isset($category['categoryColor']) ? $category['categoryColor'] : '' ?>" class="form-control">
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-8">
									<input type="checkbox" name="category_show" id="category_show" class="teal" value="1" <?php echo (isset($category['categoryShow']) && $category['categoryShow'] == '1') ? 'checked="checked"' : '' ?>>
								</div>
							</div>
                        ...
                        <div class="panel-body">
                            <div class="col-md-2 pull-right">
                                <button id="submit_btn" class="btn btn-yellow btn-block" type="submit">
                                    <?php echo isset($category) ? 'Update' : 'Submit'; ?> <i class="fa fa-arrow-circle-right"></i>
								</button>
							</div>
						</div>
                        <?php echo form_close(); ?>
...
<script>
	...
	$('#category_color').keyup(function() {
		var category_color = $(this).val();
		
		$('#color_picker').colorpicker('setValue', category_color);
	})
