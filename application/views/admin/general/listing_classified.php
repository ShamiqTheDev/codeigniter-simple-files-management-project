				...
				<div class="col-sm-12"> 
					...
					<div class="page-header row">
						...
						<div class="col-md-2 pull-right">
                            <a class="btn btn-teal btn-block" href="<?php echo $base_url; ?>admin/general/classified">
								Add 						
							</a>
						</div>
					</div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <table class="table table-striped table-bordered table-hover" id="sample_1">
                                <thead>
                                    <tr>
                                        <th class="hidden-xs" width="65%">Classified Name</th>
                                ...
                                <tbody>
									<?php
										if($classified)
										{
											foreach($classified as $key => $get_classified)
											{l
											?>
											<tr>
												
												<td><?php echo $get_classified['classifiedName']?></td>
												<td nowrap class="center">
													<div class="visible-md visible-lg hidden-sm hidden-xs">
														<a href="<?php echo $base_url; ?>admin/general/classified/<?php echo $get_classified['classifiedId']?>" class="btn btn-xs btn-teal tooltips" data-placement="top" data-original-title="Edit"><i class="fa fa-edit"></i></a>
													</div>
												</td>
											</tr>
											<?php }
