...
<div class="main-container">
	...
	<div class="main-content divHtml">
		<?php
			$attributes = array('class' => 'form-horizontal', 'role' => '', 'id' => 'sentNoteSheetForm');
			echo form_open_multipart(current_url(), $attributes);
			echo '<input type="hidden" name="attach_receipt_id" id="attach_receipt_id" value="'.$attach_receipt_id.'">';
		?>
			...
			<div class="row">
				<div class="col-sm-12"> 
					...
					<?php if (isset($message) && $message) { ?>
						<div id="message" style=""><p class="error_msg"><?php echo $message; ?></p></div>
					<?php } ?>
					...
					<div class="box_style">
						<div class="panel-body">
							...
							<div class="form-group">
								...
								<input type="hidden" name="note_sheet_id" value="<?php echo $note_sheet_id; ?>" />
							</div>
							...
							<?php } ?>
							<input type="submit" class="btn btn-success pull-right" name="sign_and_send" value="Send">
							<?php /* ?>
							<a href="#sent_note_sheet_box" data-toggle="modal" class="btn btn-success pull-right">Sign and Send</a>
							<input type="hidden" name="login_password" id="login_password">
							<?php */ ?>
							<?php /* ?>
							<button type="button" name="sent_note_sheet" value="sent_note_sheet" id="sent_note_sheet" class="btn btn-success pull-right">
								Sign and Send
							</button>
							<?php */ ?>
						</div>
				...
				<div class="col-md-6">
					<div class="gray_box">
                        <div class="row">
                            ...
                            <div class="col-md-4"><strong>File Number</strong></div>
                            <div class="col-md-4"><strong>Subject</strong></div>
                            <div class="col-md-3"><strong>Note(Chars)</strong></div>
						</div>
							...
							if($file) {
								...
								<div class="row">
									<div class="white_row">
										<div class="col-md-1">
											<div class="checkbox-table">
												<input  checked id="" name="file_id[]" value="<?php echo $get_file['fileId']; ?>" type="checkbox">
											</div>
										</div>
										<div class="col-md-4">
											<div class="accordion-custom accordion-teal" id="accordion">
												<div class="panel-default">
													<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapse_<?php echo $i; ?>">
														...
														<?php echo $get_file['fileNumber']; ?>
													</a>
												</div>
											</div>
										</div>
										<div class="col-md-4" style="color: #000;"><?php echo $get_file['description']; ?></div>
										<div class="col-md-3" style="color: #000;"><?php echo $get_file['note_sheet']['noteSheetCharCount']; ?></div>
									</div> 
										...
										<div class="panel-body details-info">
											...
											<div class="form-group">
												<div class="form-validation">
													...
													<div class="col-sm-4 file-detail">
														<?php echo $get_file['employeeCNIC']; ?>
													</div>
												</div>
												<div class="form-validation">
													<label class="col-sm-2 control-label">
													...
													<div class="col-sm-4 file-detail">
														<?php echo $get_file['employeeName']; ?>
													</div>
												</div>
											</div>
											...
											<div class="form-group">
												...
												<div class="form-validation">
													...
													<div class="col-sm-4 file-detail">
														<?php echo $file['generalCategoryName']; ?>
													</div>
												</div>
											</div>
										</div>
...
<div id="sent_note_sheet_box" class="modal fade" tabindex="-1" data-width="400" style="display: none;">
	<div class="modal-header">
	...
	<div class="modal-body">
		<div class="row">
			<div id="to_error" style="display:none; margin-left:15px; margin-top:-5px; margin-bottom:10px; color: red;">Please Select User</div>
			<div class="col-md-12" style="margin-bottom: 10px;">
				Now need verfiy your user password
			</div>
			<div class="form-group">
				<div class="form-validation">
					<label class="col-sm-2 control-label">
					...
					<div class="col-sm-10">
						<input type="password" id="verfiy_password" class="form-control">
					</div>
				</div>
			</div>
		</div>
	...
	<div class="modal-footer">
		...
		<button type="button" name="sent_note_sheet" id="sent_note_sheet" value="sent_note_sheet" class="btn btn-success pull-right">
			Sign and Send
		</button>
	</div>
</div>
...
<script>
	...
	var FormValidator = function () {
		...
		var fileUploadingForm = function () {
			...
			var form1 = $('#sentNoteSheetForm');
			var errorHandler1 = $('.errorHandler', form1);
			var successHandler1 = $('.successHandler', form1);
			$('#sentNoteSheetForm').validate({
				...
				submitHandler: function (form) {
					...
					// submit form
					//$('#form').submit();
					HTMLFormElement.prototype.submit.call($('#sentNoteSheetForm')[0]);
				}
			});
		};
	...
	$('#sent_note_sheet').click(function() {
	
		$('#login_password').val($('#verfiy_password').val());
		$('#sentNoteSheetForm').submit();
		//$('#verfiyUserForm').submit();
...
<style>
	...
	.form-group { margin:3px !important;padding: 2px 4px;}
	...
	.gray_box{ /* background: #ebedfb; */padding: 5px 20px;/* border: solid 1px #ccc; */margin-bottom: 10px;font-size: 12px;color: #fff;font-weight: bold;background: #282828;
	}
