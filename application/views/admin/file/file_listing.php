							...
							?>
								...
								<p class="action-button">
									...
									<?php if(in_array($view_type, $show_send_button)){ ?>
										<button type="button" id="send_receipt" action-form="note_sheet_send" class="receipt_submit btn btn-primary top_btn" disabled="disabled">
											Send
										</button>
									<?php } ?>
									<!--<?php if(in_array($view_type, $show_send_back_button)){ ?>
										<button type="button" id="send_back_receipt" action-form="receipt_send_back" class="receipt_submit btn btn-primary top_btn" disabled="disabled">
											Send Back
										</button>
									<?php } ?>-->
								...
								<?php //echo "<pre>";print_r($dt_datatable);exit; ?>
										...
										<tr bgcolor="ebedfb" style="color:#000;">
											...
											if($dt_datatable) {
												foreach($dt_datatable as $get_dt_datatable) {
													...
													// }
													// else {
													//echo "<pre>";print_r($dt_datatable);exit;
													//if (!empty($get_dt_datatable['th_table'])) {
