                    ...
                    <div class="panel panel-default">
						...
						<div class="panel-body">
										...
										<?php
											if($users) {
												foreach($users as $get_user) {
													$selected = (isset($_POST["user_id"]) && ($_POST["user_id"] == $get_user['uacc_id'])) ? "selected='selected'" : "" ;
													echo '<option value="'.$get_user['uacc_id'].'"'.$selected.'>'.$get_user['upro_first_name'].' '.$get_user['upro_last_name'].' ('.$get_user['uacc_username'].')</option>';
												}
											}
										?>
									</select>
							...
							<?php if(count($session_section) == 1) { ?>
								<input value="<?php echo $session_section[0]['sectionId']; ?>" type="hidden" name="section_id" id="section_id">
								<?php } else { ?>
								<div class="form-group col-md-4">
							...
							<div class="form-group col-md-4">
								...
								<div class="col-sm-7">
									<input value="<?php echo set_value('start_date'); ?>" type="text" name="start_date" id="start_date" class="form-control datepicker">
								</div>
							</div>
							...
							<div class="form-group col-md-4">
								...
								<div class="col-sm-7">
									<input value="<?php echo set_value('end_date'); ?>" type="text" name="end_date" id="end_date" class="form-control datepicker">
								</div>
							</div>
							...
							<div class="col-md-12">
								...
								<?php if (!empty($userwise_reporting)) { ?>
									<div class="form-group col-md-2 pull-right">
										<div class="col-sm-12 pull-right">
						...
						<?php if (!empty($userwise_reporting)) { ?>
							<div class="panel-body">
								<?php $this->load->view('admin/reports/userwise_table'); ?>
							</div>
						<?php } ?>
