...
class Auth_model extends CI_Model {
	...
	function register_account()
	{
		...
		$validation_rules = array(
			...
			//array('field' => 'register_section[]', 'label' => 'Designation', 'rules' => 'required'),
		...
		if ($this->form_validation->run())
		{
			...
			$section = $this->input->post('register_section');
			$designation = $this->input->post('register_designation');
            $user_group = $this->input->post('insert_group');
            $user_job_group = $this->input->post('register_user_job_group');
			...
			$response = $this->flexi_auth->insert_user($email, $username, $password, $section, $designation, $user_job_group, $profile_data, $user_group, $instant_activate);
	...
	function change_password()
	{
		...
		if ($this->form_validation->run())
		{
			...
			($response) ? redirect('auth_admin/manage_user_accounts') : redirect('auth_admin/change_password/'.$user_id);
		}
		else
		{		
			// Set validation errors.
